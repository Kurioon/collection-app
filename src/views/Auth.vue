...
<template>
  <div class="min-h-screen flex items-center justify-center p-4">
    <div class="glass-card w-full max-w-md p-8 sm:p-10">
      <h2
        class="text-3xl font-bold text-center mb-8 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-500 dark:from-purple-400 dark:to-pink-300"
      >
      ...
      <button
        ...
        class="mt-6 w-full glass-input flex justify-center items-center gap-3 hover:bg-white/60 dark:hover:bg-black/60 cursor-pointer font-medium"
      >
      ...
      <p class="mt-8 text-center text-sm">
        ...
        <button
          @click="toggleMode"
          class="text-purple-600 dark:text-purple-400 font-bold hover:underline outline-none"
        >
